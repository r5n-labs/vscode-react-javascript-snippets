...
const typescriptReactClassComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsStateInterface,
    `export default class ${Placeholders.ComponentName} extends Component<${Placeholders.ComponentProps}, State> {`,
    '  state = {}',
    '',
    ...innerComponentReturn,
    '}',
...
const typescriptReactClassExportComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsStateInterface,
    `class ${Placeholders.ComponentName} extends Component<${Placeholders.ComponentProps}, State> {`,
    '  state = {}',
    '',
    ...innerComponentReturn,
    '}',
...
const typescriptReactFunctionalExportComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `function ${Placeholders.ComponentName}({}: ${Placeholders.ComponentProps}) {`,
    ...innerComponent,
    '}',
    ...exportDefault,
  ],
...
const typescriptReactFunctionalComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `export default function ${Placeholders.ComponentName}({}: ${Placeholders.ComponentProps}) {`,
    ...innerComponent,
    '}',
  ],
  description:
...
const typescriptReactArrowFunctionExportComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `const ${Placeholders.ComponentName} = (props: ${Placeholders.ComponentProps}) => {`,
    ...innerComponent,
    '}',
    ...exportDefault,
  ],
...
const typescriptReactArrowFunctionComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `export const ${Placeholders.ComponentName} = (props: ${Placeholders.ComponentProps}) => {`,
    ...innerComponent,
    '}',
  ],
  description:
...
const typescriptReactClassPureComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `export default class ${Placeholders.ComponentName} extends PureComponent<${Placeholders.ComponentProps}> {`,
    ...innerComponentReturn,
    '}',
  ],
  description:
...
const typescriptReactClassExportPureComponent: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsTypeInterface,
    `class ${Placeholders.ComponentName} extends PureComponent<${Placeholders.ComponentProps}> {`,
    ...innerComponentReturn,
    '}',
    ...exportDefault,
  ],
...
const typescriptReactClassComponentRedux: TypescriptSnippet = {
  ...
  body: [
    ...
    '',
    ...propsStateInterface,
    `export class ${Placeholders.ComponentName} extends Component<${Placeholders.ComponentProps}, State> {`,
    '  state = {}',
    '',
    ...innerComponentReturn,
    '}',
...
const routeWithLoaderActionTypescript: TypescriptSnippet = {
  ...
  body: [
    ...
    '}',
    '',
    `function ${Placeholders.ComponentName}() {`,
