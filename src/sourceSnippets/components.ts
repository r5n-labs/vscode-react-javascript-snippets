...
const reactFunctionalComponentWithPropTypes: ComponentsSnippet = {
  ...
  body: [
    ...reactPropTypes,
    '',
    `function ${Placeholders.ComponentName}(props) {`,
    ...innerComponent,
    '}',
    '',
    `${Placeholders.ComponentName}.propTypes = {}`,
    ...exportDefault,
    '',
  ],
  description:
...
const reactArrowFunctionComponent: ComponentsSnippet = {
  ...
  body: [
    ...react,
    '',
    `export const ${Placeholders.ComponentName} = () => {`,
    ...innerComponent,
    '}',
    '',
  ],
...
const reactArrowFunctionComponentWithPropTypes: ComponentsSnippet = {
  ...
  body: [
    ...reactPropTypes,
    '',
    `const ${Placeholders.ComponentName} = props => {`,
    ...innerComponent,
    '}',
    '',
    `${Placeholders.ComponentName}.propTypes = {}`,
...
const reactFunctionalComponentRedux: ComponentsSnippet = {
  ...
  body: [
    ...reactWithReduxConnect,
    '',
    `export const ${Placeholders.ComponentName} = (props) => {`,
    ...innerComponent,
    '}',
    ...reduxComponentExport,
  ],
